...
_COL_META = {
    ...
    "Gen_headroom_MW":         ("K", "PR-11: p_gen_cap (FCR-adjusted max generation, see plant.yaml fcr.mandatory_headroom_mw) − committed_net − aFRR_up − mFRR_up. ≥0 always.", "MW"),
    "Pump_headroom_MW":        ("K", "PR-11: committed_net + p_pump_cap (FCR-adjusted max pump, see plant.yaml fcr.mandatory_headroom_mw) − aFRR_dn − mFRR_dn. ≥0 always.", "MW"),
