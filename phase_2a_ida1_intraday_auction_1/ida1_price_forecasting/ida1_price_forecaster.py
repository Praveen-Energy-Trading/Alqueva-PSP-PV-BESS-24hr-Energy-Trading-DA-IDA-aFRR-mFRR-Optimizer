...
def _auto_select_model(feat_tr: pd.DataFrame) -> str:
    ...
    # spread_lag_h1 (real previous-hour spread, not a zero placeholder) is
    # the correct "previous value" for directional_accuracy -- confirms
    # whether the model calls the spread's hour-to-hour move correctly,
    # not an artifact of always comparing against zero.
